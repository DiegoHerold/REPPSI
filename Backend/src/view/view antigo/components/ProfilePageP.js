...
const { Box, Flex, Text, Button, Stack, Textarea, Image, IconButton, SimpleGrid, Input, Icon, Grid } = require('@chakra-ui/react');
const { StarIcon, DeleteIcon, EditIcon, ChatIcon } = require('@chakra-ui/icons');
const { useToast, Avatar, Tag } = require('@chakra-ui/react');
